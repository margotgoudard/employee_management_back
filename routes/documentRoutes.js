...
router.get('/category/:id_category', documentController.getDocumentsByDocumentCategory);
router.get('/user/:id_user', documentController.getDocumentsByUser);
router.get('/category/:id_category/user/:id_user', documentController.getDocumentsByDocumentCategoryAndUser);
